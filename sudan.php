...
<head>
  ...
  <style>
    ...
    .hero {
      background: url('https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/Displaced_Children_in_Darfur.jpg/1280px-Displaced_Children_in_Darfur.jpg') no-repeat center center/cover;
      height: 350px;
      color: white;
      display: flex;
